...
set_property PACKAGE_PIN T14 [get_ports {ioc_lo[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioc_lo[0]}]
set_property PACKAGE_PIN T15 [get_ports {ioc_lo[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioc_lo[1]}]
set_property PACKAGE_PIN P14 [get_ports {ioc_lo[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioc_lo[2]}]
set_property PACKAGE_PIN R14 [get_ports {ioc_lo[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioc_lo[3]}]

set_property PACKAGE_PIN U14 [get_ports {ioc_hi[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioc_hi[0]}]
set_property PACKAGE_PIN U15 [get_ports {ioc_hi[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioc_hi[1]}]
set_property PACKAGE_PIN V17 [get_ports {ioc_hi[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioc_hi[2]}]
set_property PACKAGE_PIN V18 [get_ports {ioc_hi[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioc_hi[3]}]
